...
public class JiraCSVDaoImpl extends JdbcDaoSupport implements JiraCSVDao {
	...
	public void insert(List<? extends JiraCSV> Customers) {
		String sql = "INSERT INTO jiracsv "
				+ "(priority, issue_key, issue_id, summary, status, created, custom_field_start_date, resolved, custom_field_Location, custom_field_COX_Candidate_Level, custom_field_COX_Capgemini_Lead, custom_field_COX_Hiring_Manager, custom_field_COX_Role_Skillset,custom_field_COX_Tier_Level,custom_field_COX_Tierlevel, custom_field_Position_Backfill_New, custom_field_Cap_SL_BU,custom_field_Opportunity_Stage, custom_field_Minimun_COR_HOUR, custom_field_COX_COR, creater) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
//				ps.setLong(1, customer.getId());
				...
				ps.setString(9, customer.getCustom_field_Location());
				...
				ps.setString(15, customer.getCustom_field_COX_Tierlevel());
				...
				ps.setString(19, customer.getCustom_field_Minimun_COR_HOUR());
				ps.setString(20, customer.getCustom_field_COX_COR());
				ps.setString(21, customer.getCreater());
			}
...
//			customer.setIssue_id((int) row.get("Issue_id"));
			...
			customer.setCustom_field_Location((String) row.get("Custom_field_Location"));
			...
			customer.setCustom_field_COX_Tierlevel((String) row.get("Custom_field_COX_Tierlevel"));
			...
			customer.setCustom_field_Minimun_COR_HOUR((String) row.get("Custom_field_COR_HOUR"));
			customer.setCustom_field_COX_COR((String) row.get("Custom_field_COX_COR"));
			customer.setCreater((String) row.get("Creater"));
			result.add(customer);
		}
